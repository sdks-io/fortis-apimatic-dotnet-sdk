// <copyright file="Data24LocationId.cs" company="APIMatic">
// FortisAPI.Standard
//
...
namespace FortisAPI.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<Data24LocationId>),
        new[] {
            typeof(MStringCase)
        },
        false
    ...
    public abstract class Data24LocationId
    {
        ...
        /// </summary>
        /// <returns>
        /// The Data24LocationId instance, wrapping the provided string value.
        /// </returns>
        public static Data24LocationId FromString(string mString)
        {
        ...
        private sealed class MStringCase : Data24LocationId, ICaseValue<MStringCase, string>
        {
            public string Value;
