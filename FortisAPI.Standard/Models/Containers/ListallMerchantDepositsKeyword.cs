// <copyright file="ListallMerchantDepositsKeyword.cs" company="APIMatic">
// FortisApi.Standard
//
...
namespace FortisApi.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<ListallMerchantDepositsKeyword>),
        new System.Type[] {
            typeof(MStringCase),
    ...
    public abstract class ListallMerchantDepositsKeyword
    {
        ...
        /// </summary>
        /// <returns>
        /// The ListallMerchantDepositsKeyword instance, wrapping the provided string value.
        /// </returns>
        public static ListallMerchantDepositsKeyword FromString(string mString)
        {
        ...
        /// </summary>
        /// <returns>
        /// The ListallMerchantDepositsKeyword instance, wrapping the provided double value.
        /// </returns>
        ...
        private sealed class MStringCase : ListallMerchantDepositsKeyword, ICaseValue<MStringCase, string>
        {
            public string Value;
        ...
        private sealed class PrecisionCase : ListallMerchantDepositsKeyword, ICaseValue<PrecisionCase, double>
        {
            public double Value;
