// <copyright file="List15LocationId.cs" company="APIMatic">
// FortisApi.Standard
//
...
namespace FortisApi.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<List15LocationId>),
        new System.Type[] {
            typeof(MStringCase)
        },
        false
    ...
    public abstract class List15LocationId
    {
        ...
        /// </summary>
        /// <returns>
        /// The List15LocationId instance, wrapping the provided string value.
        /// </returns>
        public static List15LocationId FromString(string mString)
        {
        ...
        private sealed class MStringCase : List15LocationId, ICaseValue<MStringCase, string>
        {
            public string Value;
