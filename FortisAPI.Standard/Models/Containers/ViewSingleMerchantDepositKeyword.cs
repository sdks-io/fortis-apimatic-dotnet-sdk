// <copyright file="ViewSingleMerchantDepositKeyword.cs" company="APIMatic">
// FortisApi.Standard
//
...
namespace FortisApi.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<ViewSingleMerchantDepositKeyword>),
        new System.Type[] {
            typeof(MStringCase),
    ...
    public abstract class ViewSingleMerchantDepositKeyword
    {
        ...
        /// </summary>
        /// <returns>
        /// The ViewSingleMerchantDepositKeyword instance, wrapping the provided string value.
        /// </returns>
        public static ViewSingleMerchantDepositKeyword FromString(string mString)
        {
        ...
        /// </summary>
        /// <returns>
        /// The ViewSingleMerchantDepositKeyword instance, wrapping the provided double value.
        /// </returns>
        ...
        private sealed class MStringCase : ViewSingleMerchantDepositKeyword, ICaseValue<MStringCase, string>
        {
            public string Value;
        ...
        private sealed class PrecisionCase : ViewSingleMerchantDepositKeyword, ICaseValue<PrecisionCase, double>
        {
            public double Value;
