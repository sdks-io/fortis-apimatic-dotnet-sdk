...
namespace FortisAPI.Standard.Models
{
    ...
    public class V1WalletProviderMerchantDetailsRequest : BaseModel
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is V1WalletProviderMerchantDetailsRequest other &&
                (this.MerchantOrigin == null && other.MerchantOrigin == null ||
                 this.MerchantOrigin?.Equals(other.MerchantOrigin) == true) &&
                base.Equals(obj);
        }
        ...
        {
            toStringOutput.Add($"MerchantOrigin = {this.MerchantOrigin ?? "null"}");
