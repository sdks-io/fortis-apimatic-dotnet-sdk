...
namespace FortisApi.Standard.Models
{
    ...
    public class Data39
    {
        ...
        public Data39(
            ...
            Models.Resource12? resource = null,
        ...
        public Models.Resource12? Resource { get; set; }

        /// <summary>
        /// Maximum number of attempts on failure
        /// </summary>
        [JsonProperty("number_of_attempts", NullValueHandling = NullValueHandling.Ignore)]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is Data39 other &&
                ...
                (this.OnCreate == null && other.OnCreate == null ||
                 this.OnCreate?.Equals(other.OnCreate) == true) &&
                (this.OnUpdate == null && other.OnUpdate == null ||
                 this.OnUpdate?.Equals(other.OnUpdate) == true) &&
                (this.OnDelete == null && other.OnDelete == null ||
                 this.OnDelete?.Equals(other.OnDelete) == true) &&
                ...
                (this.NumberOfAttempts == null && other.NumberOfAttempts == null ||
                 this.NumberOfAttempts?.Equals(other.NumberOfAttempts) == true) &&
        ...
        protected void ToString(List<string> toStringOutput)
        {
            ...
            toStringOutput.Add($"OnCreate = {(this.OnCreate == null ? "null" : this.OnCreate.ToString())}");
            toStringOutput.Add($"OnUpdate = {(this.OnUpdate == null ? "null" : this.OnUpdate.ToString())}");
            toStringOutput.Add($"OnDelete = {(this.OnDelete == null ? "null" : this.OnDelete.ToString())}");
            ...
            toStringOutput.Add($"NumberOfAttempts = {(this.NumberOfAttempts == null ? "null" : this.NumberOfAttempts.ToString())}");
