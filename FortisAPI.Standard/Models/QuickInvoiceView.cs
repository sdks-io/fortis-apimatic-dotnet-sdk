...
namespace FortisAPI.Standard.Models
{
    ...
    public class QuickInvoiceView : BaseModel
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is QuickInvoiceView other &&
                (this.Id == null && other.Id == null ||
                 this.Id?.Equals(other.Id) == true) &&
                (this.QuickInvoiceId == null && other.QuickInvoiceId == null ||
                 this.QuickInvoiceId?.Equals(other.QuickInvoiceId) == true) &&
                (this.RemoteIp == null && other.RemoteIp == null ||
                 this.RemoteIp?.Equals(other.RemoteIp) == true) &&
        ...
        protected new void ToString(List<string> toStringOutput)
        {
            ...
            toStringOutput.Add($"RemoteIp = {this.RemoteIp ?? "null"}");
