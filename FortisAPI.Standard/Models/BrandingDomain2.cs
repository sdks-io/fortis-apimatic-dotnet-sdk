// <copyright file="BrandingDomain2.cs" company="APIMatic">
// FortisApi.Standard
//
...
namespace FortisApi.Standard.Models
{
    ...
    public class BrandingDomain2
    {
        ...
        private Dictionary<string, bool> shouldSerialize = new Dictionary<string, bool>
        {
            ...
            { "custom_theme", false },
            { "custom_css", false },
            { "custom_stylesheet_url", false },
        };

        /// <summary>
        /// Initializes a new instance of the <see cref="BrandingDomain2"/> class.
        /// </summary>
        ...
        /// <param name="customStylesheetUrl">custom_stylesheet_url.</param>
        ...
        public BrandingDomain2(
            ...
            bool? allowContactSignup = null,
            bool? allowContactRegistration = null,
            bool? allowContactLogin = null,
            List<Models.RegistrationField> registrationFields = null,
            ...
            object contactUserDefaultEntryPage = null,
            object contactUserDefaultAuthRoles = null,
            string customStylesheetUrl = null,
            string id = null,
            int? createdTs = null,
            int? modifiedTs = null)
        {
        ...
        /// </summary>
        [JsonProperty("allow_contact_signup", NullValueHandling = NullValueHandling.Ignore)]
        public bool? AllowContactSignup { get; set; }

        /// <summary>
        /// Allow Contact Registration.
        /// </summary>
        [JsonProperty("allow_contact_registration", NullValueHandling = NullValueHandling.Ignore)]
        public bool? AllowContactRegistration { get; set; }

        /// <summary>
        /// Allow Contact Login.
        /// </summary>
        [JsonProperty("allow_contact_login", NullValueHandling = NullValueHandling.Ignore)]
        ...
        public List<Models.RegistrationField> RegistrationFields { get; set; }
        ...
        /// <summary>
        /// Gets or sets ContactUserDefaultEntryPage.
        /// </summary>
        [JsonProperty("contact_user_default_entry_page", NullValueHandling = NullValueHandling.Ignore)]
        public object ContactUserDefaultEntryPage { get; set; }
        ...
        /// </summary>
        [JsonProperty("custom_stylesheet_url")]
        public string CustomStylesheetUrl
        {
            get
            {
            ...
            set
            {
                this.shouldSerialize["custom_stylesheet_url"] = true;
                this.customStylesheetUrl = value;
            }
        }
        ...
        public override string ToString()
        {
            ...
            return $"BrandingDomain2 : ({string.Join(", ", toStringOutput)})";
        }
        ...
        {
            this.shouldSerialize["custom_stylesheet_url"] = false;
        }
        ...
        /// </summary>
        /// <returns>A boolean weather the field should be serialized or not.</returns>
        public bool ShouldSerializeCustomStylesheetUrl()
        {
            return this.shouldSerialize["custom_stylesheet_url"];
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is BrandingDomain2 other &&
                ...
                (this.SupportEmail == null && other.SupportEmail == null ||
                 this.SupportEmail?.Equals(other.SupportEmail) == true) &&
                (this.AllowContactSignup == null && other.AllowContactSignup == null ||
                 this.AllowContactSignup?.Equals(other.AllowContactSignup) == true) &&
                (this.AllowContactRegistration == null && other.AllowContactRegistration == null ||
                 this.AllowContactRegistration?.Equals(other.AllowContactRegistration) == true) &&
                (this.AllowContactLogin == null && other.AllowContactLogin == null ||
                 this.AllowContactLogin?.Equals(other.AllowContactLogin) == true) &&
                (this.RegistrationFields == null && other.RegistrationFields == null ||
                 this.RegistrationFields?.Equals(other.RegistrationFields) == true) &&
                (this.CompanyName == null && other.CompanyName == null ||
                 this.CompanyName?.Equals(other.CompanyName) == true) &&
                (this.NavColor == null && other.NavColor == null ||
                 this.NavColor?.Equals(other.NavColor) == true) &&
                (this.ButtonPrimaryColor == null && other.ButtonPrimaryColor == null ||
                 this.ButtonPrimaryColor?.Equals(other.ButtonPrimaryColor) == true) &&
                (this.LogoBackgroundColor == null && other.LogoBackgroundColor == null ||
                 this.LogoBackgroundColor?.Equals(other.LogoBackgroundColor) == true) &&
                (this.IconBackgroundColor == null && other.IconBackgroundColor == null ||
                 this.IconBackgroundColor?.Equals(other.IconBackgroundColor) == true) &&
                (this.MenuTextBackgroundColor == null && other.MenuTextBackgroundColor == null ||
                 this.MenuTextBackgroundColor?.Equals(other.MenuTextBackgroundColor) == true) &&
                (this.MenuTextColor == null && other.MenuTextColor == null ||
                 this.MenuTextColor?.Equals(other.MenuTextColor) == true) &&
                (this.RightMenuBackgroundColor == null && other.RightMenuBackgroundColor == null ||
                 this.RightMenuBackgroundColor?.Equals(other.RightMenuBackgroundColor) == true) &&
                (this.RightMenuTextColor == null && other.RightMenuTextColor == null ||
                 this.RightMenuTextColor?.Equals(other.RightMenuTextColor) == true) &&
                (this.ButtonPrimaryTextColor == null && other.ButtonPrimaryTextColor == null ||
                 this.ButtonPrimaryTextColor?.Equals(other.ButtonPrimaryTextColor) == true) &&
                (this.NavLogo == null && other.NavLogo == null ||
                 this.NavLogo?.Equals(other.NavLogo) == true) &&
                (this.FavIcon == null && other.FavIcon == null ||
                 this.FavIcon?.Equals(other.FavIcon) == true) &&
                (this.AesKey == null && other.AesKey == null ||
                 this.AesKey?.Equals(other.AesKey) == true) &&
                (this.HelpText == null && other.HelpText == null ||
                 this.HelpText?.Equals(other.HelpText) == true) &&
                ...
                (this.CustomJavascript == null && other.CustomJavascript == null ||
                 this.CustomJavascript?.Equals(other.CustomJavascript) == true) &&
                (this.CustomTheme == null && other.CustomTheme == null ||
                 this.CustomTheme?.Equals(other.CustomTheme) == true) &&
                (this.CustomCss == null && other.CustomCss == null ||
                 this.CustomCss?.Equals(other.CustomCss) == true) &&
                (this.ContactUserDefaultEntryPage == null && other.ContactUserDefaultEntryPage == null ||
                 this.ContactUserDefaultEntryPage?.Equals(other.ContactUserDefaultEntryPage) == true) &&
                (this.ContactUserDefaultAuthRoles == null && other.ContactUserDefaultAuthRoles == null ||
                 this.ContactUserDefaultAuthRoles?.Equals(other.ContactUserDefaultAuthRoles) == true) &&
                (this.CustomStylesheetUrl == null && other.CustomStylesheetUrl == null ||
                 this.CustomStylesheetUrl?.Equals(other.CustomStylesheetUrl) == true) &&
        ...
        protected void ToString(List<string> toStringOutput)
        {
            ...
            toStringOutput.Add($"SupportEmail = {this.SupportEmail ?? "null"}");
            toStringOutput.Add($"AllowContactSignup = {(this.AllowContactSignup == null ? "null" : this.AllowContactSignup.ToString())}");
            toStringOutput.Add($"AllowContactRegistration = {(this.AllowContactRegistration == null ? "null" : this.AllowContactRegistration.ToString())}");
            toStringOutput.Add($"AllowContactLogin = {(this.AllowContactLogin == null ? "null" : this.AllowContactLogin.ToString())}");
            toStringOutput.Add($"RegistrationFields = {(this.RegistrationFields == null ? "null" : $"[{string.Join(", ", this.RegistrationFields)} ]")}");
            toStringOutput.Add($"CompanyName = {this.CompanyName ?? "null"}");
            toStringOutput.Add($"NavColor = {this.NavColor ?? "null"}");
            toStringOutput.Add($"ButtonPrimaryColor = {this.ButtonPrimaryColor ?? "null"}");
            toStringOutput.Add($"LogoBackgroundColor = {this.LogoBackgroundColor ?? "null"}");
            toStringOutput.Add($"IconBackgroundColor = {this.IconBackgroundColor ?? "null"}");
            toStringOutput.Add($"MenuTextBackgroundColor = {this.MenuTextBackgroundColor ?? "null"}");
            toStringOutput.Add($"MenuTextColor = {this.MenuTextColor ?? "null"}");
            toStringOutput.Add($"RightMenuBackgroundColor = {this.RightMenuBackgroundColor ?? "null"}");
            toStringOutput.Add($"RightMenuTextColor = {this.RightMenuTextColor ?? "null"}");
            toStringOutput.Add($"ButtonPrimaryTextColor = {this.ButtonPrimaryTextColor ?? "null"}");
            toStringOutput.Add($"NavLogo = {this.NavLogo ?? "null"}");
            toStringOutput.Add($"FavIcon = {this.FavIcon ?? "null"}");
            toStringOutput.Add($"AesKey = {this.AesKey ?? "null"}");
            toStringOutput.Add($"HelpText = {this.HelpText ?? "null"}");
            toStringOutput.Add($"EmailReplyTo = {this.EmailReplyTo ?? "null"}");
            toStringOutput.Add($"Email = {this.Email ?? "null"}");
            toStringOutput.Add($"CustomJavascript = {this.CustomJavascript ?? "null"}");
            toStringOutput.Add($"CustomTheme = {this.CustomTheme ?? "null"}");
            toStringOutput.Add($"CustomCss = {this.CustomCss ?? "null"}");
            toStringOutput.Add($"ContactUserDefaultEntryPage = {(this.ContactUserDefaultEntryPage == null ? "null" : this.ContactUserDefaultEntryPage.ToString())}");
            ...
            toStringOutput.Add($"CustomStylesheetUrl = {this.CustomStylesheetUrl ?? "null"}");
