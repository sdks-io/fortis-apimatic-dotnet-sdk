// <copyright file="ProductFile1.cs" company="APIMatic">
// FortisAPI.Standard
//
...
namespace FortisAPI.Standard.Models
{
    ...
    /// ProductFile1.
    /// </summary>
    public class ProductFile1 : BaseModel
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductFile1"/> class.
        /// </summary>
        public ProductFile1()
        {
        }
        ...
        public ProductFile1(
            string title = null,
            string productFileCredentialId = null,
        ...
        /// </summary>
        [JsonProperty("product_file_credential_id", NullValueHandling = NullValueHandling.Ignore)]
        ...
        public override string ToString()
        {
            ...
            return $"ProductFile1 : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is ProductFile1 other &&
                (this.Title == null && other.Title == null ||
                 this.Title?.Equals(other.Title) == true) &&
                (this.ProductFileCredentialId == null && other.ProductFileCredentialId == null ||
                 this.ProductFileCredentialId?.Equals(other.ProductFileCredentialId) == true) &&
                (this.FreeBytes == null && other.FreeBytes == null ||
                 this.FreeBytes?.Equals(other.FreeBytes) == true) &&
                (this.ByteIncrement == null && other.ByteIncrement == null ||
                 this.ByteIncrement?.Equals(other.ByteIncrement) == true) &&
                (this.MaxFileSizeBytes == null && other.MaxFileSizeBytes == null ||
                 this.MaxFileSizeBytes?.Equals(other.MaxFileSizeBytes) == true) &&
                (this.IncrementCost == null && other.IncrementCost == null ||
                 this.IncrementCost?.Equals(other.IncrementCost) == true) &&
                (this.MonthlyFee == null && other.MonthlyFee == null ||
                 this.MonthlyFee?.Equals(other.MonthlyFee) == true) &&
                (this.FileExtAllowed == null && other.FileExtAllowed == null ||
                 this.FileExtAllowed?.Equals(other.FileExtAllowed) == true) &&
                (this.Container == null && other.Container == null ||
                 this.Container?.Equals(other.Container) == true) &&
        ...
        protected new void ToString(List<string> toStringOutput)
        {
            ...
            toStringOutput.Add($"ProductFileCredentialId = {this.ProductFileCredentialId ?? "null"}");
            toStringOutput.Add($"FreeBytes = {(this.FreeBytes == null ? "null" : this.FreeBytes.ToString())}");
            toStringOutput.Add($"ByteIncrement = {(this.ByteIncrement == null ? "null" : this.ByteIncrement.ToString())}");
            toStringOutput.Add($"MaxFileSizeBytes = {(this.MaxFileSizeBytes == null ? "null" : this.MaxFileSizeBytes.ToString())}");
            toStringOutput.Add($"IncrementCost = {(this.IncrementCost == null ? "null" : this.IncrementCost.ToString())}");
            toStringOutput.Add($"MonthlyFee = {(this.MonthlyFee == null ? "null" : this.MonthlyFee.ToString())}");
            toStringOutput.Add($"FileExtAllowed = {this.FileExtAllowed ?? "null"}");
            toStringOutput.Add($"Container = {this.Container ?? "null"}");
