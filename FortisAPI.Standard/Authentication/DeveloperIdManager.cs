...
namespace FortisApi.Standard.Authentication
{
    ...
    public sealed class DeveloperIdModel
    {
        ...
        internal static DeveloperIdModel FromOptions(DeveloperIdModelOptions options)
        {
            var builder = new Builder(options.DeveloperId);
            return builder.Build();
        }
    }

    public class DeveloperIdModelOptions
    {
