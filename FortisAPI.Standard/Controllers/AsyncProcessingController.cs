...
namespace FortisApi.Standard.Controllers
{
    ...
    public class AsyncProcessingController : BaseController
    {
        ...
        /// <returns>Returns the ApiResponse of Models.ResponseAsyncStatus response from the API call.</returns>
        public ApiResponse<Models.ResponseAsyncStatus> StatusCheck(
                Guid statusCode)
        ...
        /// <returns>Returns the ApiResponse of Models.ResponseAsyncStatus response from the API call.</returns>
        public async Task<ApiResponse<Models.ResponseAsyncStatus>> StatusCheckAsync(
                Guid statusCode,
