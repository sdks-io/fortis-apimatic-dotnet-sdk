...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `Data` property of this instance returns the response data which is of type [Models.ResponseTransactionBinInfo](../../doc/models/response-transaction-bin-info.md).
...
try
{
    ApiResponse<ResponseTransactionBinInfo> result = await transactionsReadController.GetBinInfoAsync(transactionId);
}
...
GetTransactionAsync(
    ...
    List<Models.Field57> fields = null)
```
...
try
{
    ApiResponse<ResponseTransaction> result = await transactionsReadController.GetTransactionAsync(transactionId);
}
catch (ApiException e)
{
    Console.WriteLine(e.Message);
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `Data` property of this instance returns the response data which is of type [Models.ResponseTransactionsCollection](../../doc/models/response-transactions-collection.md).
...
try
{
    ApiResponse<ResponseTransactionsCollection> result = await transactionsReadController.ListTransactionsAsync(
        page,
        order,
        filterBy
    );
