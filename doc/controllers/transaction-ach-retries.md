...
```csharp
TransactionAchRetriesController transactionAchRetriesController = client.TransactionAchRetriesController;
```
...
```csharp
CreateaTransactionAchRetryAsync(
    Models.V1TransactionAchRetriesRequest body,
    List<Models.Expand57> expand = null)
```
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `Data` property of this instance returns the response data which is of type [Models.ResponseTransactionAchRetry](../../doc/models/response-transaction-ach-retry.md).

## Example Usage

```csharp
V1TransactionAchRetriesRequest body = new V1TransactionAchRetriesRequest
{
...
try
{
    ApiResponse<ResponseTransactionAchRetry> result = await transactionAchRetriesController.CreateaTransactionAchRetryAsync(body);
}
...
```csharp
ListallTransactionAchRetriesrelatedAsync(
    ...
    List<Models.Field55> fields = null)
```
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `Data` property of this instance returns the response data which is of type [Models.ResponseTransactionAchRetrysCollection](../../doc/models/response-transaction-ach-retrys-collection.md).
...
try
{
    ApiResponse<ResponseTransactionAchRetrysCollection> result = await transactionAchRetriesController.ListallTransactionAchRetriesrelatedAsync(
        page,
        order,
        filterBy
    );
...
```csharp
ViewsingleTransactionAchRetryrecordAsync(
...
try
{
    ApiResponse<ResponseTransactionAchRetry> result = await transactionAchRetriesController.ViewsingleTransactionAchRetryrecordAsync(transactionAchRetryId);
}
catch (ApiException e)
{
    Console.WriteLine(e.Message);
