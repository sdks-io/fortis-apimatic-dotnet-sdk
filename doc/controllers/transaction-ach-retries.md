...
CreateATransactionACHRetryAsync(
    ...
    List<Models.Expand57Enum> expand = null)
```
...
[`Task<Models.ResponseTransactionAchRetry>`](../../doc/models/response-transaction-ach-retry.md)
...
try
{
    ResponseTransactionAchRetry result = await transactionACHRetriesController.CreateATransactionACHRetryAsync(body);
}
...
ListAllTransactionACHRetriesRelatedAsync(
    ...
    List<Models.Field55Enum> fields = null)
```
...
[`Task<Models.ResponseTransactionAchRetrysCollection>`](../../doc/models/response-transaction-ach-retrys-collection.md)
...
try
{
    ResponseTransactionAchRetrysCollection result = await transactionACHRetriesController.ListAllTransactionACHRetriesRelatedAsync(
        page,
        order,
        filterBy
    );
...
try
{
    ResponseTransactionAchRetry result = await transactionACHRetriesController.ViewSingleTransactionACHRetryRecordAsync(transactionAchRetryId);
}
catch (ApiException e)
{
    Console.WriteLine(e.Message);
