...
```csharp
V1TransactionsEbtVoucherClearRefundKeyedRequest body = new V1TransactionsEbtVoucherClearRefundKeyedRequest
{
...
```csharp
V1TransactionsEbtVoucherClearSaleKeyedRequest body = new V1TransactionsEbtVoucherClearSaleKeyedRequest
{
    AccountNumber = "5454545454545454",
    ExpDate = "0722",
    AuthCode = "abc12345",
