...
CreateanewsignaturerecordAsync(
    ...
    List<Models.Expand34> expand = null)
```
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `Data` property of this instance returns the response data which is of type [Models.ResponseSignature](../../doc/models/response-signature.md).
...
try
{
    ApiResponse<ResponseSignature> result = await signaturesController.CreateanewsignaturerecordAsync(body);
}
...
ListallsignaturesrecordAsync(
    ...
    List<Models.Field45> fields = null)
```
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `Data` property of this instance returns the response data which is of type [Models.ResponseSignaturesCollection](../../doc/models/response-signatures-collection.md).
...
try
{
    ApiResponse<ResponseSignaturesCollection> result = await signaturesController.ListallsignaturesrecordAsync(
        page,
        order,
        filterBy
    );
...
try
{
    ApiResponse<ResponseSignature> result = await signaturesController.ViewsinglesignaturerecordAsync(signatureId);
}
catch (ApiException e)
{
    Console.WriteLine(e.Message);
