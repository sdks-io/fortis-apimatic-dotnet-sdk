...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `Data` property of this instance returns the response data which is of type [Models.ResponsePaymentCardReaderToken](../../doc/models/response-payment-card-reader-token.md).
...
try
{
    ApiResponse<ResponsePaymentCardReaderToken> result = await paymentCardReaderTokenController.PaymentCardReaderTokenRequestAsync(productTransactionId);
}
