...
| `IntervalType` | [`IntervalType`](../../doc/models/interval-type.md) | Required | - |
...
| `StartDate` | `string` | Required | Start date<br><br>**Constraints**: *Maximum Length*: `10`, *Pattern*: `^[\d]{4}-[\d]{2}-[\d]{2}$` |
