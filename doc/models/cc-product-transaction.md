...
| `SubProcessor` | `string` | Optional | Sub Processor<br><br>**Constraints**: *Maximum Length*: `48` |
...
| `CardTypeEbt` | `bool?` | Optional | Card Type EBT |
| `AllowEbtCashBenefit` | `bool?` | Optional | Allow EBT Cash Benefit |
| `AllowEbtFoodStamp` | `bool?` | Optional | Allow EBT Food Stamp |
...
| `MerchantId` | `string` | Optional | Merchant ID<br><br>**Constraints**: *Maximum Length*: `24` |
| `ReceiptHeader` | `string` | Optional | Receipt Header<br><br>**Constraints**: *Maximum Length*: `255` |
| `ReceiptFooter` | `string` | Optional | Receipt Footer<br><br>**Constraints**: *Maximum Length*: `255` |
...
| `DupCheckPerBatch` | `string` | Optional | Dup Check Per Batch<br><br>**Constraints**: *Maximum Length*: `500` |
| `AgentCode` | `string` | Optional | Agent Code<br><br>**Constraints**: *Maximum Length*: `16`, *Pattern*: `^[\w\-]+$` |
...
| `AllowSoftpos` | `bool?` | Optional | Allow Soft POS |
...
| `CurrentStan` | `double?` | Optional | Current Stan<br><br>**Default**: `1` |
...
| `ProductTransactionApiId` | `string` | Optional | Product Transaction API ID<br><br>**Constraints**: *Pattern*: `^(([0-9a-fA-F\-]{24,36})\|(([0-9a-fA-F]{8})-(([0-9a-fA-F]{4}\-){3})([0-9a-fA-F]{12})))$` |
