...
| `TerminalApiId` | `string` | Optional | Advance Deposit<br><br>**Constraints**: *Maximum Length*: `36` |
| `EFormat` | `object` | Optional | - |
| `ETrackData` | `string` | Optional | Encrypted Track Data |
| `ESerialNumber` | `string` | Optional | Encrypted Track Data KSN<br><br>**Constraints**: *Maximum Length*: `20` |
