...
| `SecureCryptogram` | `string` | Optional | (ECOMM) Used to supply the Digital Payment Cryptogram obtained from a Digital Secure Remote Payment (DSRP) transaction |
...
| `WalletType` | `object` | Optional | - |
| `ClerkId` | `string` | Optional | Clerk ID |
| `VoucherNumber` | `string` | Optional | Voucher Number |
| `InitiationType` | `object` | Optional | - |
| `BillPayment` | `bool?` | Optional | If transaction is a bill payment |
| `DelayCharge` | `bool?` | Optional | Delay Charge |
| `DeferredAuth` | `bool?` | Optional | Deferred Auth |
| `MiniBar` | `bool?` | Optional | Mini Bar |
| `EbtFoodEligibleAmount` | `int?` | Optional | EBT Food Eligible Amount<br><br>**Constraints**: `>= 0`, `<= 999999999` |
| `EbtCashEligibleAmount` | `int?` | Optional | EBT Cash Eligible Amount<br><br>**Constraints**: `>= 0`, `<= 999999999` |
| `AccountVaultId` | `string` | Optional | DEPRECATED (Use token_id instead).<br><br>**Constraints**: *Pattern*: `^(([0-9a-fA-F\-]{24,36})\|(([0-9a-fA-F]{8})-(([0-9a-fA-F]{4}\-){3})([0-9a-fA-F]{12})))$` |
...
| `AccountVaultApiId` | `string` | Optional | DEPRECATED (Use token_api_id instead).<br><br>**Constraints**: *Maximum Length*: `36` |
...
| `AuthCode` | `string` | Required | Required on force transactions and EBT voucher clear sale/refund. Ignored for all other actions.<br><br>**Constraints**: *Maximum Length*: `6` |
| `TransId` | `string` | Optional | Trans ID<br><br>**Constraints**: *Maximum Length*: `15` |
