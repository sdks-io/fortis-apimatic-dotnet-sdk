...
| `DeliveryTimeframe` | [`DeliveryTimeframeEnum?`](../../doc/models/delivery-timeframe-enum.md) | Optional | Indicates the merchandise delivery timeframe.<br><br>> 01 - Electronic Delivery<br>> <br>> 02 - Same day shipping<br>> <br>> 03 - Overnight shipping<br>> <br>> 04 - Two-day or more shipping |
| `DeliveryEmailAddress` | `string` | Optional | For electronic delivery, the email address to which the merchandise was delivered. |
| `ReorderItemsInd` | [`ReorderItemsIndEnum?`](../../doc/models/reorder-items-ind-enum.md) | Optional | Indicates whether the cardholder is reordering previously purchased merchandise.<br><br>> 01 - First time ordered<br>> <br>> 02 - Reordered |
| `PreOrderPurchaseInd` | [`PreOrderPurchaseIndEnum?`](../../doc/models/pre-order-purchase-ind-enum.md) | Optional | Indicates whether Cardholder is placing an order for merchandise with a future availability or release date.<br><br>> 01 - Merchandise available<br>> <br>> 02 - Future availability |
...
| `TransChar` | [`List<TransCharEnum>`](../../doc/models/trans-char-enum.md) | Optional | Available starting in EMV 3DS 2.3.1.1.  Indicates to the ACS specific transactions identified by the Merchant.<br><br>> 01 - Cryptocurrency transaction<br>> <br>> 02 - NFT transaction<br><br>**Constraints**: *Minimum Items*: `1`, *Maximum Items*: `2` |
