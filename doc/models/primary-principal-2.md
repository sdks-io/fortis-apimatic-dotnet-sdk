...
|  --- | --- | --- | --- |
| `FirstName` | `string` | Required | Signer's first name<br><br>**Constraints**: *Maximum Length*: `20` |
| `LastName` | `string` | Required | Signer's last name<br><br>**Constraints**: *Maximum Length*: `20` |
