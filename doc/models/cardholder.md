...
| `BillingAddress` | [`BillingAddress24`](../../doc/models/billing-address-24.md) | Optional | Cardholder billing address object |
...
| `HomePhone` | [`HomePhone`](../../doc/models/home-phone.md) | Optional | The home phone provided by the Cardholder. Refer to ITU-E.164 for additional information on format and length.<br><br>This field is required if available, unless market or regional mandate restricts sending this information. |
| `MobilePhone` | [`MobilePhone`](../../doc/models/mobile-phone.md) | Optional | The mobile phone provided by the Cardholder. Refer to ITU-E.164 for additional information on format and length.<br><br>This field is required if available, unless market or regional mandate restricts sending this information. |
| `WorkPhone` | [`WorkPhone`](../../doc/models/work-phone.md) | Optional | The work phone provided by the Cardholder. Refer to ITU-E.164 for additional information on format and length.<br><br>This field is required if available, unless market or regional mandate restricts sending this information. |
...
| `ShippingAddress` | [`ShippingAddress`](../../doc/models/shipping-address.md) | Optional | Cardholder shipping address object |
