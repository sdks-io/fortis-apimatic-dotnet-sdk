...
| `LastName` | `string` | Required | Last Name<br><br>**Constraints**: *Maximum Length*: `64` |
...
| `PrimaryLocationId` | `string` | Required | Primary Location ID<br><br>**Constraints**: *Pattern*: `^(([0-9a-fA-F\-]{24,36})\|(([0-9a-fA-F]{8})-(([0-9a-fA-F]{4}\-){3})([0-9a-fA-F]{12})))$` |
...
| `UserTypeCode` | [`UserTypeCode`](../../doc/models/user-type-code.md) | Required | - |
