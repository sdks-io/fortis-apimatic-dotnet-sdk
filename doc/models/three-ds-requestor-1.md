...
|  --- | --- | --- | --- |
| `ThreeDsRequestorAuthenticationInd` | [`ThreeDsRequestorAuthenticationInd`](../../doc/models/three-ds-requestor-authentication-ind.md) | Required | - |
| `ThreeDsRequestorAuthenticationInfo` | [`List<ThreeDsRequestorAuthenticationInfo>`](../../doc/models/three-ds-requestor-authentication-info.md) | Optional | Information about how the 3DS Requestor authenticated the cardholder before or during the transaction. |
...
| `ThreeDsRequestorDecReqInd` | [`ThreeDsRequestorDecReqInd?`](../../doc/models/three-ds-requestor-dec-req-ind.md) | Optional | - |
...
| `ThreeDsRequestorSpcSupport` | [`ThreeDsRequestorSpcSupport?`](../../doc/models/three-ds-requestor-spc-support.md) | Optional | - |
| `SpcIncompInd` | `string` | Optional | Reason that the SPC authentication was not completed.<br>This field is required if device_channel = 02 (BRW) and the 3DS Requestor attempts to invoke SPC API and there is an error. Available for supporting EMV 3DS 2.3.1 and later versions. |
