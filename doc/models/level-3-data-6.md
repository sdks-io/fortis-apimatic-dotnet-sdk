...
| `FreightAmount` | `int?` | Optional | Freight or shipping portion of the total transaction amount ,Can accept Two (2) decimal places.<br><br>**Constraints**: `>= 0`, `<= 999999999900` |
...
| `LineItems` | [`List<LineItem20>`](../../doc/models/line-item-20.md) | Required | Array of line items in transaction |
